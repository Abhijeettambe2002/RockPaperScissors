document.addEventListener("DOMContentLoaded", function() {
    ...
    function hardMode() {
        resetGame();
        targetRounds = 3;
        result.innerText = "Hard Mode activated: First to 2 rounds.";
        updateRoundsRemaining();
        enableGameButtons();
    }
    ...
    function mediumMode() {
        resetGame();
        targetRounds = 5;
        result.innerText = "Medium Mode activated: First to 4 rounds.";
        updateRoundsRemaining();
        enableGameButtons();
    }
    ...
    function easyMode() {
        resetGame();
        targetRounds = 6;
        result.innerText = "Easy Mode activated: First to 6 rounds.";
        updateRoundsRemaining();
        enableGameButtons();
    }
        ...
        if (targetRounds > 0) {
            if (round_count >= targetRounds) {
                if (playerScore > computerScore) {
                    ...
                    console.log('yes:');
                    finalScoreDisplay.innerText = `${final_score}`; 
